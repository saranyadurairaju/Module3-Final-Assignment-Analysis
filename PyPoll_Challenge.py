#ELECTION AUDIT RESULTS FOR ELECTION COMMISSION
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # Add the non matching candidate to the list.
        ...
        # If statement to checks the county does not match with the list.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_count > largest_county_count) and (county_percentage > largest_county_percentage):
            largest_county_count = county_count
    ...
    for candidate_name in candidate_votes:
        ...
        # Print candidate's voter count, percentage to the terminal.
        print(candidate_results)
        # Save the candidate results to our text file.
        txt_file.write(candidate_results)

        # Finding winning vote count, winning percentage, and candidate.
